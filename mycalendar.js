//Getting the accurate current date, month and year
...
var mainCalendar = document.querySelector(".mycalendar-days")
...
const renderCalendar = () => {
    ...
    for (let i=firstDayOfTheMonth; i > 0; i--){
        mycalendarBox +=`<div class="day-num inactive">
    ...
    for (let i = 1; i<=lastDateOftheMonth; i++){
        ...
        mycalendarBox +=`<div class="day-num ${today}" >
                            ${i}
                        </div>`;
    }
    ...
    mainCalendar.innerHTML = mycalendarBox
